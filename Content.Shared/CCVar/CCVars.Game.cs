...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<string>
        GameLobbyDefaultPreset = CVarDef.Create("game.defaultpreset", "Frontier", CVar.ARCHIVE); // Eclipse: change default to Frontier
    ...
    /// </summary>
    public static readonly CVarDef<string>
        GameLobbyFallbackPreset = CVarDef.Create("game.fallbackpreset", "Frontier", CVar.ARCHIVE); // Eclipse: change default to Frontier
